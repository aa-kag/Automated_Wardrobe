...
# class ClothingItem:
#     def __init__(self, clothing_name, category, color, style, material, temperature_suitability, precipitation_suitability):
#         self.clothing_name = clothing_name
#         self.category = category
#         self.color = color
#         self.style = style
...
#     cursor = conn.cursor() 
#     cursor.execute("""
#         INSERT INTO my_wardrobe (clothing_name, category, color, style, material, temperature_suitability, precipitation_suitability)
#         VALUES (?, ?, ?, ?, ?, ?, ?)""",
#         (clothing.clothing_name, clothing.category, clothing.color, clothing.style,
#          clothing.material, ",".join(clothing.temperature_suitability), int(clothing.precipitation_suitability)))
#     conn.commit()
#     conn.close()
...
#     wardrobe = []
#     for i in rows: 
#         id_, clothing_name, category, color, style, material, temperature_suitability, precipitation_suitability = i
#         clothing = ClothingItem(
#             item_number = id_,
#             clothing_name=clothing_name,
#             category=category,
